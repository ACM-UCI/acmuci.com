...
<section id="content" class="home">
	<div class="inner">
		...
		<div id="main-stream">
			<h2>Competitions</h2>
			<p>Our active competition participants train
			rigorously to compete in nationally renown
			competitions such as those listed below. Contact
			Kenny Baldauf, the current Competitions
			...
			<h2>Projects</h2>
			<p>We support the development of ambitious
			students by providing tools necessary to
			establish projects and find other students to
			collaborate with.</p>

			<img class="left c4" src="images/flask_128.png" />
			<p class="left c4">Have an idea that you need help with? Pitch your
			idea to Gio Borje and we'll throw it into our
			incubator.</p>

			<img class="left c4" src="images/blueprint_128.png" />
			<p class="left c4">Looking to contribute to other
			projects?  See <a
			href="http://redmine.acmuci.com/">our projects
			group</a> for a list of ongoing projects by our
			members.</p>
		</div>
	</div>
</section>
